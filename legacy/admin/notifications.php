...
<head>
  <meta charset="UTF-8">
  <title>Расписание МГППУ | Центр уведомлений</title>
        ...
        <div class="row">
          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="jumbotron">
              ...
              <div class="col-md-6">
                <a class="btn btn-lg btn-success" href="email-sender.php">
                  <i class="glyphicon glyphicon-notes"></i> Отправить E-Mail рассылку</a>
              </div>
              <div class="col-md-6">
                <a class="btn btn-info btn-lg" href="email-sender.php">
                  <i class="glyphicon glyphicon-cargo"></i> Архив E-Mail рассылок</a>
              </div>
            </div>
            ...
            <div class="jumbotron">
              ...
              <div class="col-md-6">
                <div class="col-md-6">
                  <a class="btn btn-lg btn-success" href="sms-sender.php">
                    <i class="glyphicon glyphicon-envelope"></i>Отправить СМС сообщение</a>
                </div>
              </div>
              <div class="col-md-6">
                <a class="btn btn-info btn-lg" href="sms-archive.php">
                  <i class="glyphicon glyphicon-compressed"></i>Архив СМС сообщений</a>
              </div>
            </div>

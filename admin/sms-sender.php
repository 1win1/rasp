...
<head>
  <meta charset="UTF-8">
  <title>Расписание МГППУ | Отправка СМС</title>
    ...
    <aside class="right-side">
      ...
      <section class="content">
        <div class="col-md-6">
          ...
          if ($_POST['number'] AND $_POST['text']){
          echo "SEND";
          ...
          "api_id"        =>  "36a4746a-4547-af24-85c7-06121d62b82a",
          "to"            =>  $_POST['number'],
          "partner_id"    =>  "9640",
          "text"      => iconv( "windows-1251", $_POST['text'])
        ...
        <div class="col-md-6">
          <p class="text-info">
            Было отправлено столько-то сообщений:
          </p>
          <p>%number_messages%</p>
        </div>
      </section>

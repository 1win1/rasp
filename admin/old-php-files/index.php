            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="http://google.ru" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
